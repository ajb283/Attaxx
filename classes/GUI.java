...
class GUI extends TopLevel implements View, CommandSource, Reporter {
    ...
    private synchronized void autoRed(String unused) {
        send("auto red");
    }

    private synchronized void autoBlue(String unused) {
        send("auto blue");
    }

    private synchronized void manualRed(String unused) {
        send("manual red");
    }

    private synchronized void manualBlue(String unused) {
        send("manual blue");
    }
